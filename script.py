...
X,y,Xtest,ytest = pickle.load(open('D:\Nikhil\Savefiles\Downloads\CSE 14\ML CSE574\PA2\sample.pickle','rb'))            
...
X,y,Xtest,ytest = pickle.load(open('D:\Nikhil\Savefiles\Downloads\CSE 14\ML CSE574\PA2\diabetes.pickle','rb'))   
# add intercept
